...
public class Oblig2Test
{
	...
	public static int oppgave1()
	{
		...
		catch(Exception e)
		{
			...
			{
				System.out.println("Oppgave 1d: Kaster feil type unntak for null-tabell!");
				antallFeil++;
			}
		}
	...
	public static int oppgave2()
	{
		...
		try
		{
			liste.leggInn(null);
			antallFeil++;
			System.out.println("Oppgave 2c: leggInn skal stoppe null-verdier!");
		}
		catch(Exception e)
		{
			if(!(e instanceof NullPointerException))
			{
				System.out.println("Oppgave 2d: Kaster feil type unntak for null-verdier i leggInn!");
				antallFeil++;
			}
		}
		...
		{
			antallFeil++;
			System.out.println("Oppgave 2f: Tom liste skal gi []!");
		}
		...
		{
			antallFeil++;
			System.out.println("Oppgave 2g: Du har " + s + ", skal være [1]!");
		}
		...
		{
			antallFeil++;
			System.out.println("Oppgave 2h: Du har " + s + ", skal være [1]!");
		}
		...
		{
			antallFeil++;
			System.out.println("Oppgave 2i: Du har " + s + ", skal være [1, 2]!");
		}
		...
		{
			antallFeil++;
			System.out.println("Oppgave 2j: Du har " + s + ", skal være [2, 1]!");
		}
		...
		{
			antallFeil++;
			System.out.println("Oppgave 2k: Du har " + s + ", skal være [1, 2, 3, 4]!");
		}
		...
		{
			antallFeil++;
			System.out.println("Oppgave 2l: Du har " + s + ", skal være [4, 3, 2, 1]!");
		}
		...
		{
			antallFeil++;
			System.out.println("Oppgave 2m: Du har " + t2 + ", men det skal være " + t1);
		}
	...
	public static int oppgave3()
	{
		...
		if(liste.hent(3) != 4 || liste.hent(2) != 3 || liste.hent(1) != 2 || liste.hent(0) != 1)
		{
			antallFeil++;
		...
		catch(Exception e)
		{
			if(!(e instanceof NullPointerException))
			{
				System.out.println("Oppgave 3k: Feil unntak for nullverdier i oppdater()!");
				antallFeil++;
			}
		}
		...
		try
		{
			liste.oppdater(4, 5);
			antallFeil++;
			System.out.println("Oppgave 3l: En liste med fire verdier har ikke indeks lik 4");
		}
		catch(Exception e)
		{
			if(!(e instanceof IndexOutOfBoundsException))
			{
				System.out.println("Oppgave 3m: Metoden kaster feil type unntak for indeksfeil!");
				antallFeil++;
			}
		}
		...
		{
			antallFeil++;
			System.out.println("Oppgave 3n: Metoden oppdater() returnerer feil verdi!");
		}

		if(liste.antall() != 4)
		{
			antallFeil++;
			System.out.println("Oppgave 3o: antallEndringer skal økes, men antall skal ikke endres!");
		}

		if(liste.hent(3) != 5)
		{
			antallFeil++;
			System.out.println("Oppgave 3p: Metoden oppdater() setter verdien feil!");
		}

		if(liste.oppdater(0, -1) != 1)
		{
			antallFeil++;
			System.out.println("Oppgave 3q: Metoden oppdater() returnerer feil verdi!");
		}

		if(liste.hent(0) != -1)
		{
			antallFeil++;
			System.out.println("Oppgave 3r: Metoden oppdater() setter verdien feil!");
		}
		...
		{
			antallFeil++;
			System.out.println("Oppgave 3s: Du har " + s + ", skal være [-1, 2, 3, 5]!");
		}
		...
		{
			antallFeil++;
			System.out.println("Oppgave 3t: Du har " + s + ", skal være [5, 3, 2, -1]!");
		}
	...
	public static int oppgave4()
	{
		...
		if(liste.indeksTil(1) != 0 || liste.indeksTil(3) != 1 || liste.indeksTil(5) != 2 || liste.indeksTil(7) != 3)
		{
			antallFeil++;
		...
		try
		{
			...
			{
				antallFeil++;
				System.out.println("Oppgave 4f: Skal returnere -1 for null-verdier!");
			}
		}
		catch(Exception e)
		{
			System.out.println("Oppgave 4g: Skal ikke kaste unntak, men returnere -1 for null-verdier!");
			antallFeil++;
		}

		if(liste.inneholder(1) != true || liste.inneholder(7) != true || liste.inneholder(0) != false || liste.inneholder(6) != false)
		{
			antallFeil++;
		...
		{
			antallFeil++;
			System.out.println("Oppgave 4i: Skal gi indeks til første forekomst hvis like verdier!");
		}
	...
	public static int oppgave5()
	{
		...
		try
		{
			liste.leggInn(-1, 1);
			antallFeil++;
			System.out.println("Oppgave 5a: Kan ikke legge inn på indeks -1!");
		}
		catch(Exception e)
		{
			if(!(e instanceof IndexOutOfBoundsException))
			{
				System.out.println("Oppgave 5b: Kaster feil type unntak for indeksfeil!");
				antallFeil++;
			}
		}
		...
		catch(Exception e)
		{
			if(!(e instanceof NullPointerException))
			{
				System.out.println("Oppgave 5f: Det kastes feil type unntak for null-verdier!");
				antallFeil++;
			}
		}
		...
		{
			System.out.println("Oppgave 5g: Feil i indekssjekken! 0 <= indeks <= antall er tillatt!");
		...
		{
			antallFeil++;
			System.out.println("Oppgave 5h: Feil i antall-oppdateringen i metoden leggInn()!");
		}
	...
	public static int oppgave6()
	{
		...
		catch(Exception e)
		{
			if(!(e instanceof IndexOutOfBoundsException))
			{
				System.out.println("Oppgave 6b: Indekssjekken kaster feil unntak!");
				antallFeil++;
			}
		}

		liste = new DobbeltLenketListe<>(new String[]
		{ "A", "B", "C", "D", "E", "F", "G" });
		...
		if(liste.fjern(" ") == true || liste.fjern("G") == true || liste.fjern("J") == true)
		{
			antallFeil++;
		...
		if(liste.fjern("F") != true || liste.fjern("I") != true)
		{
			antallFeil++;
		...
		{
			antallFeil++;
			System.out.println("Oppgave 6q: Feil i antall-oppdateringen metoden fjern(T)!");
		}
		...
		try
		{
			...
			{
				antallFeil++;
				System.out.println("Oppgave 6r: skal returnere false for en null-verdi!");
			}
		}
		catch(Exception e)
		{
			System.out.println("Oppgave 6s: Skal ikke kaste unntak, men returnere false for en null-verdi!");
			antallFeil++;
		}
		...
		if(liste.fjern(new String("A")) != true || liste.fjern(new String("E")) != true || liste.fjern(new String("C")) != true || liste.fjern(new String("B")) != true || liste.fjern(new String("D")) != true)
		{
			antallFeil++;
		...
		{
			System.out.println("Oppgave 6u: Her kastes det et unntak, men det skal ikke skje!!");
			antallFeil++;
		}

		if(!liste.toString().equals("[]"))
		{
			System.out.println("Oppgave 6v: Her må det være en pekerfeil!");
			antallFeil++;
		}

		if(!liste.omvendtString().equals("[]"))
		{
			System.out.println("Oppgave 6w: Her må det være en pekerfeil!");
			antallFeil++;
		}
		...
		{
			System.out.println("Oppgave 6x: Her kastes det et unntak, men det skal ikke skje!!");
			antallFeil++;
		}

		if(!liste.toString().equals("[]"))
		{
			System.out.println("Oppgave 6y: Her må det være en pekerfeil!");
			antallFeil++;
		}

		if(!liste.omvendtString().equals("[]"))
		{
			System.out.println("Oppgave 6z: Her må det være en pekerfeil!");
			antallFeil++;
		}
		...
		{
			System.out.println("Oppgave 6zb: Her må det være en pekerfeil!");
			antallFeil++;
		}

		if(!liste.omvendtString().equals("[A]"))
		{
			System.out.println("Oppgave 6zc: Her må det være en pekerfeil!");
			antallFeil++;
		}
		...
		{
			System.out.println("Oppgave 6zd: Her kastes det et unntak, men det skal ikke skje!!");
			antallFeil++;
		}

		if(!liste.toString().equals("[A]"))
		{
			System.out.println("Oppgave 6ze: Her må det være en pekerfeil!");
			antallFeil++;
		}

		if(!liste.omvendtString().equals("[A]"))
		{
			System.out.println("Oppgave 6zf: Her må det være en pekerfeil!");
			antallFeil++;
		}
	...
	public static int oppgave7()
	{
		...
		{
			antallFeil++;
			System.out.println("Oppgave 7a: Feil i antalloppdateringen i nullstill!");
		}
	...
	public static int oppgave8()
	{
		...
		try
		{
			...
			System.out.println("Oppgave 8a: Skal kastes unntak for next() i en tom liste!");
			antallFeil++;
		}
		catch(Exception e)
		{
		...
		if(i.next() != 1)
		{
			System.out.println("Oppgave 8c: Metoden next() gir feil verdi!");
			antallFeil++;
		}
		...
		try
		{
			...
			System.out.println("Oppgave 8d: Skal kastes unntak for next() her!");
			antallFeil++;
		}
		catch(Exception e)
		{
		...
		try
		{
			i.next();
			antallFeil++;
			System.out.println("Oppgave 8g: ForventetAntallEndringer ikke endret i fjern(indeks)!");
		}
		catch(Exception e)
		{
		...
		try
		{
			i.next();
			antallFeil++;
			System.out.println("Oppgave 8i: ForventetAntallEndringer ikke endret i leggInn(T)!");
		}
		catch(Exception e)
		{
			if(!(e instanceof ConcurrentModificationException))
		...
		i = liste.iterator();
		liste.fjern(new Integer(8)); // bruker fjern(T) etter at iteratoren er
										// opprettet
		...
		try
		{
			i.next();
			antallFeil++;
			System.out.println("Oppgave 8k: ForventetAntallEndringer ikke endret i fjern(T)!");
		}
		catch(Exception e)
		{
			if(!(e instanceof ConcurrentModificationException))
		...
		i = liste.iterator();
		liste.leggInn(0, 1); // bruker leggInn(indeks,T) etter at iteratoren er
								// opprettet
		...
		try
		{
			i.next();
			antallFeil++;
			System.out.println("Oppgave 8m: ForventetAntallEndringer ikke endret i leggInn(indeks,T)!");
		}
		catch(Exception e)
		{
			if(!(e instanceof ConcurrentModificationException))
		...
		try
		{
			i.next();
			antallFeil++;
			System.out.println("Oppgave 8o: ForventetAntallEndringer ikke endret i oppdater()!");
		}
		catch(Exception e)
		{
			if(!(e instanceof ConcurrentModificationException))
		...
		try
		{
			i.next();
			antallFeil++;
			System.out.println("Oppgave 8q: ForventetAntallEndringer ikke endret i nullstill()!");
		}
		catch(Exception e)
		{
			if(!(e instanceof ConcurrentModificationException))
	...
	public static int oppgave9()
	{
		...
		try
		{
			liste.forEach(null);
			antallFeil++;
			System.out.println("Oppgave 9a: Skal kaste unntak hvis handling er null!");
		}
		catch(Exception e)
		{
			if(!(e instanceof NullPointerException))
		...
		{
			System.out.println("Oppgave 9c: forEach virker ikke som den skal!");
			antallFeil++;
		}
		...
		{
			System.out.println("Oppgave 9d: forEach virker ikke som den skal for tom liste!");
			antallFeil++;
		}
		...
		{
			System.out.println("Oppgave 9e: forEach virker ikke for liste med ett element!");
			antallFeil++;
		}
		...
		try
		{
			...
			antallFeil++;
			System.out.println("Oppgave 9f: Skal kaste unntak hvis handling er null!");
		}
		catch(Exception e)
		{
			if(!(e instanceof NullPointerException))
		...
		{
			System.out.println("Oppgave 9h: forEach virker ikke som den skal for tom liste!");
			antallFeil++;
		}
		...
		{
			System.out.println("Oppgave 9i: forEachRemaining virker ikke som den skal!");
			antallFeil++;
		}
		...
		{
			System.out.println("Oppgave 9j: forEachRemaining virker ikke som den skal!");
			antallFeil++;
		}
	...
	public static int oppgave10()
	{
		...
		{
			antallFeil++;
			System.out.println("Oppgave 10a: Feil i antall-oppdatering i remove()!");
		}
